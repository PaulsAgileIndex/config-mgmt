...
cat << EOF
   ...
   #############################################################
   ##                                                         ##
   ##  Start application "confd-consul-spring-boot"           ##
   ##  for stages:                                            ##
   ##                                                         ##
   ##  dev  (8080)                                            ##
   ##  test (8081)                                            ##
...
## Stage: dev
docker kill confd-consul-spring-boot-dev
docker rm confd-consul-spring-boot-dev
docker run -itd -p 8080:8080 -e"CONFD_PREFIX=dev" -e"CONSUL_NODE=172.17.0.1:8500" --name=confd-consul-spring-boot-dev --network=bridge avoodoo/confd-consul-spring-boot:1.0-SNAPSHOT
## Stage: test
docker kill confd-consul-spring-boot-test
docker rm confd-consul-spring-boot-test
docker run -itd -p 8081:8080 -e"CONFD_PREFIX=test" -e"CONSUL_NODE=172.17.0.1:8500" --name=confd-consul-spring-boot-test --network=bridge avoodoo/confd-consul-spring-boot:1.0-SNAPSHOT
## Stage: uat
docker kill confd-consul-spring-boot-uat
docker rm confd-consul-spring-boot-uat
docker run -itd -p 8082:8080 -e"CONFD_PREFIX=uat" -e"CONSUL_NODE=172.17.0.1:8500" --name=confd-consul-spring-boot-uat --network=bridge avoodoo/confd-consul-spring-boot:1.0-SNAPSHOT
## Stage: prod
docker kill confd-consul-spring-boot-prod
docker rm confd-consul-spring-boot-prod
docker run -itd -p 8083:8080 -e"CONFD_PREFIX=prod" -e"CONSUL_NODE=172.17.0.1:8500" --name=confd-consul-spring-boot-prod --network=bridge avoodoo/confd-consul-spring-boot:1.0-SNAPSHOT
