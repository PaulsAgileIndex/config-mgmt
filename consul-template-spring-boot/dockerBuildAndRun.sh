...
## Stage: dev
curl -X PUT -d 'DEV:ConfigurationManagementBlueprint' http://localhost:8500/v1/kv/dev/base/info/deployed/application
...
## Stage: test
curl -X PUT -d 'TEST:ConfigurationManagementBlueprint' http://localhost:8500/v1/kv/test/base/info/deployed/application
...
## Stage: uat
curl -X PUT -d 'UAT:ConfigurationManagementBlueprint' http://localhost:8500/v1/kv/uat/base/info/deployed/application
...
## Stage: prod
curl -X PUT -d 'ConfigurationManagementBlueprint' http://localhost:8500/v1/kv/prod/base/info/deployed/application
